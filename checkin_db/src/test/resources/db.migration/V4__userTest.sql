...
INSERT INTO user_dto(github_id)
VALUES ('Finalmaestro'),
       ('DenKue');

INSERT INTO klausur_ref_dto(user_dto, klausur_dto)
VALUES ('Finalmaestro', 1),
       ('DenKue', 2),
       ('Finalmaestro', 4);
...
INSERT INTO urlaub_ref_dto(user_dto, urlaub_dto)
VALUES ('Finalmaestro', 3),
       ('DenKue', 2),
       ('Finalmaestro', 4);
